"""
Django settings for RHManager project.
...
SECRET_KEY = 'django-insecure-^)%ydkvvd$zyad-mrrg_s4p_g+q6v(3r66%m$%3mj981yqddki'
...
WSGI_APPLICATION = 'RHManager.wsgi.application'
